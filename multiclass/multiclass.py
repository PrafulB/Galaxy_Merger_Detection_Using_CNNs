...
def train(model, epochs, imagesPath, statusesWritePath, mode, training_type):
    ...
    trainingGenerator = createGenerator(imagesPath + '/images_training')
...
if __name__ == '__main__':
    ...
    imagesPath = os.environ['PROJECT_DIR'] + "/multiclass/dataset"
    checkpointsPath = os.environ['PROJECT_DIR'] + "/multiclass/checkpoints" + "/" + modelRunningNow
    statusesWritePath = os.environ['PROJECT_DIR'] + "/multiclass/statuses" + "/" + modelRunningNow
    print(sys.argv)
